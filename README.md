...
- ⏳ **Phase 2 — Fidelity** — #59 Infograpify reference workflow (`reference` CLI + [docs/infograpify-reference.md](docs/infograpify-reference.md); originals never committed), #58 premium patterns, #12 extract fidelity (loss-ledger), #10 domain patterns (academic/medical).
