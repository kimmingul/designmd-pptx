...
- ⏳ **Phase 2 — Fidelity** — #59 Infograpify reference (`reference` CLI + [docs/infograpify-reference.md](docs/infograpify-reference.md); originals never committed), #58 premium patterns (10), #12 extract fidelity (charts/SmartArt/groups + loss ledger), #10 domain patterns (`consort_flow`, `kaplan_meier`, `forest_plot`, …).
