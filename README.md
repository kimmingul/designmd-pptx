...
- ⏳ **Phase 2 — Fidelity** — #12 extract fidelity (chart data + SmartArt text fallback + group walk + loss ledger), #10 domain patterns (academic/medical); premium patterns track in parallel (#58).
